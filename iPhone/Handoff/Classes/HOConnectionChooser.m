...
@implementation HOConnectionChooser

@synthesize network, items;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	cell.textLabel.text = [(MYBonjourService *)[self.items objectAtIndex:indexPath.row] name];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	[self.network openConnection: (MYBonjourService *)[self.items objectAtIndex:indexPath.row]];
...
- (void)dealloc {
	...
	[self.network removeObserver:self forKeyPath:@"serviceList"];
